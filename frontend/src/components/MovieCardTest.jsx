...
const MovieCard = () => {
    return (
        <div style={{ transform: 'scale(0.95)' }} className=' mx-auto bg-white rounded-3xl shadow-xl'>
            <div className="relative grid max-w-[370px] shadow-sm bg-slate-100  flex-col">
                <img
                    ...
                    alt="movie.title"
                />
                <span className="absolute w-full text-center bg-[#F69C9C] bottom-48 left-0 px-6 py-3 text-black text-[19px] font-semibold">FULL HD VIETSUB</span>
